...
public class GoodDao {
    ...
    public Good findGoodByProductName(String productName){
        ...
        try {
            Connection con = DriverManager.getConnection("jdbc:ucanaccess://C:\\Users\\15222\\Desktop\\vCampus.mdb", "", "");
            ...
            good.setGoodId(res.getString(1));
            good.setGoodName(res.getString(2));
            good.setGoodPrice(res.getDouble(3));
            good.setCategory(res.getString(4));
            good.setProvider(res.getString(5));
            good.setGoodStock(res.getInt(6));
