...
public class ChatInnerResp {
    ...
    public ChatInnerResp(String id, String object, String created, String result, Boolean is_truncated, Boolean need_clear_history, view.message.usage usage) {
        this.id = id;
        this.object = object;
    ...
    public view.message.usage getUsage() {
        return usage;
    }

    public void setUsage(view.message.usage usage) {
        this.usage = usage;
    }
}
